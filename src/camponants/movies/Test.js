        ...
        <>
            ...
            <div className='bg-gray-900 pl-16 pt-24 max-sm:pt-14 max-md:px-1 min-h-screen'>
                <div>
                    ...
                    <h1 className='text-xl p-3'>hii</h1>
                </div>
                    ...
                    <div className='flex flex-wrap h-auto'>
                        {
                            video.map((item, index) => {
                                return(
                                    <div className='relative m-2 rounded-lg w-[23%] max-md:w-[95%] mb-14 max-h-60 min-h-60' key={index}>
                                        <img
                                        ...
                                        (item.joinedData[0] === undefined) ? (
                                            ...
                                            <div>{
                                                  showBookmark = false  }
                                                {
                                                item.joinedData.map((joinData)=> {
                                                    
                                                   if(joinData.email === userName){
                                                        showBookmark = true
                                                        return
                                                 }
                                                })
